 ...
 *
 */
public class FlightTelemetryUsingCoreAPI {
    ...
    private static DAG buildDAG() {
        ...
        Vertex assignAirport = dag.newVertex("assignAirport", mapP(FlightTelemetryUsingCoreAPI::assignAirport)).localParallelism(1);
        ...
        Vertex addVerticalDirection = dag.newVertex("addVerticalDirection", mapP(FlightTelemetryUsingCoreAPI::assignDirection));
